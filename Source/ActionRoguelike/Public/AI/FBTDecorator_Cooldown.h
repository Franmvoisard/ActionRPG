...
#include "FBTDecorator_Cooldown.generated.h"

struct FFBTCooldownDecoratorMemory
{
...
class ACTIONROGUELIKE_API UFBTDecorator_Cooldown : public UBTDecorator
{
	GENERATED_BODY()

	UFBTDecorator_Cooldown();
